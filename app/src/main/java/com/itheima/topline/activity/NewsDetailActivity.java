...
public class NewsDetailActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        r1_title_bar.setBackgroundColor(getResources().getColor(R.color.rdTextColorPress));
    ...
    private void initWebView() {
        ...
        // 设置WebView默认使用第三方或者系统浏览器打开网页的行为，使用WebView打开
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                ll_loading.setVisibility(View.GONE); // 当加载完成时隐藏动画
            }
        });
    }
}
